<%@ page language="java" contentType="text/html; charset=utf-8"
	pageEncoding="utf-8" import="yovera.dominio.propiedades,java.util.*"%>
										...
										<table
											...
											<tbody>
												...
												<c:forEach items="${lista}" var="reg">
													<tr>
														<td><a href="categoria?accion=edit&id=${reg.getId() }" class="btn btn-warning btn-sm"><i
																class="fas fa-edit"></i> </a>
															<a class="btn btn-danger btn-sm" href="categoria?accion=delete&id=${reg.getId() }">
